...
const crearReto = async (reto) => {
    const sql = 'INSERT INTO public.retos (id_reto, id_usuario, id_tipo_reto, dependencia, problema, antecedentes, interesados, impacto_esperado) VALUES($1, $2, $3, $4, $5, $6, $7, $8);'
