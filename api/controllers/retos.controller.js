...
const crearReto = async (reto) => {
    const sql = 'INSERT INTO public.retos (id_usuario, id_tipo_reto, dependencia, problema, antecedentes, interesados, impacto_esperado,  premio, fecha) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9);'
    const datos = [reto.id_usuario, reto.id_tipo_reto, reto.dependencia, reto.problema, reto.antecedentes, reto.interesados, reto.impacto_esperado, reto.premio, reto.fecha]
